...
class User(AbstractUser):
    ...
    user_type = models.CharField(max_length=1, choices=User_type_CHOICES,blank=True,null=True,verbose_name="نوع کاربر")
    special_user = models.DateTimeField(default=timezone.now, verbose_name="کاربر ویژه")
    code = models.IntegerField(blank=True,null=True,verbose_name="کد کاربر")
