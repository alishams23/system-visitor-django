...
path('History_purchase_list_visitor/<int:pk>/<str:visitor>/',History_purchase_list_visitor.as_view(),name="History_purchase_list_visitor"),#لیست خریدهای مشتری بر اساس ویزیتور
